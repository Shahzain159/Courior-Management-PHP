...
if (isset($_GET["uid"])) {
    $id = $_GET["uid"];
    $query = "SELECT * from c_status WHERE c_status_id='$id' ";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $uid = $_GET["uid"];
    $query2 = "UPDATE c_status SET  c_status_c_id=' $c_status_c_id', trac_id='$trac_id', c_status='$c_status', c_expected_date='$c_expected_date', c_recieve_info='$c_recieve_info' WHERE c_status_id='$uid'";
...
<option value="<?php  echo $row2["c_status_c_id"] ?>"><?php  echo $row2["c_status_c_id"] ?></option>
</select>
<!-- value=" echo 'ODR'.(rand());"  -->
<input class="form-control mt-3" placeholder="Enter Tracking ID" required type="text" name="trac_id" value="<?php  echo $row2["trac_id"] ?>">
<input class="form-control mt-3" placeholder="Enter Courier Status" required type="text" name="c_status" value="<?php  echo $row2["c_status"] ?>">
<input class="form-control mt-3" placeholder="Enter Courier Expected Date" required type="datetime-local" name="c_expected_date" value="<?php  echo $row2["c_expected_date"] ?>">
<input class="form-control mt-3" placeholder="Enter Courier Recieve Information" required type="text" name="c_recieve_info" value="<?php  echo $row2["c_recieve_info"] ?>">
<input style="background-color: orangered;color:white;" class="btn btn mt-3 w-100" type="submit" value="Update Courier Status">
