...
if(isset($_SESSION["user"])){
    $b_user_id = $_SESSION["user"]["u_id"];
    $query2 = "SELECT * FROM create_bill WHERE b_user_id='$b_user_id'";
        ...
        <div class="container"><a class="navbar-brand" href="index.html"><img src="assets/img/gallery/logo.png" height="45" alt="logo" /></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto pt-2 pt-lg-0 font-base">
              ...
              <li class="nav-item px-2"><a class="nav-link" href="#bill">Courier Bill</a></li>
 ...
 <div class="dropdown">
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
    ...
    //   if(isset($res2)){
      ...
      <div class="card m-6 w-80" style=" text-align: center;"  id="bill">
  <div class="card-header card text-dark bg-primary mb-3">
       <h1 style="color: white;font-family: serif;">Courier Bills</h1>
  </div>
  <ul class="list-group list-group-flush card text-dark bg-primary mb-3">
    <li class="list-group-item bg-warning mb-3">User ID:</li>
    <li class="list-group-item ">'.$row["b_user_id"].'</li>
    <li class="list-group-item bg-warning mb-3">Courier ID:</li>
    <li class="list-group-item">'.$row["b_cor_id"].'</li>
    <li class="list-group-item bg-warning mb-3">Courier Price:</li>
    <li class="list-group-item">'.$row["b_price"].'</li>
    <li class="list-group-item bg-warning mb-3">Courier Delivery Date:</li>
    <li class="list-group-item">'.$row["b_diliver_date"].'</li>
  </ul>
</div>
';
      }
