...
if ($_SERVER["REQUEST_METHOD"] == "POST"){ 
  ...
  $query = "INSERT INTO contact VALUES(NULL,'$con_name','$con_email','$con_msg')";
...
<html lang="en-US" dir="ltr">
  ...
  </ul>      <!-- <form class="d-flex my-3 d-block d-lg-none">
  ...
  <div class="row justify-content-center">
    ...
    <div class="col-md-6 col-lg-5 col-xl-4">
      <form class="row" method="post" enctype="multipart/form-data">
        <div class="mb-3">
          <label class="form-label visually-hidden" min="2" for="inputName">Name</label>
          <input required class="form-control form-quriar-control" name="con_name" id="inputName" type="text" placeholder="Enter Name ..." />
        </div>
        <div class="mb-3">
          <label class="form-label visually-hidden" for="inputEmail">Another label</label>
          <input required class="form-control form-quriar-control" name="con_email" id="inputEmail" type="email" placeholder="Enter Email ..." />
        </div>
        <div class="mb-5">
          <label class="form-label visually-hidden" for="validationTextarea">Message</label>
          <textarea required class="form-control form-quriar-control is-invalid border-400" name="con_msg" id="validationTextarea" placeholder="Enter Message ..." style="height: 150px" required="required"></textarea>
        </div>
        <div class="d-grid">
