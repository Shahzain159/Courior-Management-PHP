...
if(isset($_GET["did"])){
    ...
    mysqli_query($conn,"DELETE FROM create_agent WHERE agent_id = $id");
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
 ...
 $query = "INSERT INTO create_agent Values (Null,'$name','$email','$pass2')";
 mysqli_query($conn,$query);

}
$r = mysqli_query($conn,"SELECT * FROM create_agent");
...
<div class="text-center d-none d-md-inline">
    ...
    <input class="form-control mt-3" required type="text" name="agent_name" placeholder="Name">
            <input class="form-control mt-3" required  type="email" name="agent_email" placeholder="Email">
            <input class="form-control mt-3" min="8" required  type="text" name="agent_password" placeholder="Password">
           
            <!-- <input class="form-control mt-3" min="8" type="text"required name="password" placeholder="Confirm Password"> -->
             <hr>
            <input style="background-color: orangered;color:white;" class="btn btn mt-3 w-100" type="submit" style="opacity:100% !important;" value="Register">
